...
$jscomp.makeIterator = function (k) {
  const n = typeof Symbol != 'undefined' && Symbol.iterator && k[Symbol.iterator];
...
$jscomp.getGlobal = function (k) {
  k = [typeof globalThis == 'object' && globalThis, k, typeof window == 'object' && window, typeof self == 'object' && self, typeof global == 'object' && global];
...
function $jscomp$lookupPolyfilledValue(k, n) {
  let l = $jscomp.propertyToPolyfillSymbol[n];
...
$jscomp.polyfillUnisolated = function (k, n, l, p) {
  ...
  p = l[k];
  n = n(p);
  n != p && n != null && $jscomp.defineProperty(l, k, { configurable: !0, writable: !0, value: n });
};
    ...
    (k
      ...
      : n !== l &&
        (void 0 === $jscomp.propertyToPolyfillSymbol[h] &&
          ((l = (1e9 * Math.random()) >>> 0), ($jscomp.propertyToPolyfillSymbol[h] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(h) : `${$jscomp.POLYFILL_PREFIX + l}$${h}`)),
...
$jscomp.polyfill(
  ...
  (k) => {
    ...
    if (
      k &&
      (!($jscomp.FORCE_POLYFILL_PROMISE || ($jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION && typeof $jscomp.global.PromiseRejectionEvent === 'undefined')) ||
    ...
    const p = $jscomp.global.setTimeout;
    ...
    h.prototype.resolveToNonPromiseObj_ = function (f) {
      ...
      typeof q == 'function' ? this.settleSameAsThenable_(q, f) : this.fulfill_(f);
    };
    ...
    h.prototype.settle_ = function (f, q) {
      if (this.state_ != 0) throw new Error(`Cannot settle(${f}, ${q}): Promise already settled in state${this.state_}`);
      this.state_ = f;
      this.result_ = q;
    ...
    h.prototype.scheduleUnhandledRejectionCheck_ = function () {
      ...
      p(() => {
        if (f.notifyUnhandledRejection_()) {
          ...
          typeof q !== 'undefined' && q.error(f.result_);
        }
      }, 1);
    };
    h.prototype.notifyUnhandledRejection_ = function () {
      if (this.isRejectionHandled_) return !1;
      let f = $jscomp.global.CustomEvent;
      const q = $jscomp.global.Event;
      const v = $jscomp.global.dispatchEvent;
    ...
    h.prototype.executeOnSettledCallbacks_ = function () {
      if (this.onSettledCallbacks_ != null) {
        for (let f = 0; f < this.onSettledCallbacks_.length; ++f) A.asyncExecute(this.onSettledCallbacks_[f]);
    ...
    h.prototype.settleSameAsThenable_ = function (f, q) {
      const v = this.createResolveAndReject_();
      try {
      ...
      function v() {
        switch (z.state_) {
          ...
          case 2:
            ...
            break;
          default:
            throw new Error(`Unexpected state: ${z.state_}`);
        }
      }
      var z = this;
      this.onSettledCallbacks_ == null ? A.asyncExecute(v) : this.onSettledCallbacks_.push(v);
    ...
    h.race = function (f) {
      return new h((q, v) => {
        for (let z = $jscomp.makeIterator(f), O = z.next(); !O.done; O = z.next()) l(O.value).callWhenSettled_(q, v);
      });
    };
    h.all = function (f) {
      const q = $jscomp.makeIterator(f);
      let v = q.next();
      return v.done
        ? l([])
        : new h((z, O) => {
  ...
  $jscomp.TRUST_ES6_POLYFILLS && typeof Object.assign == 'function'
    ...
    : function (k, n) {
        for (let l = 1; l < arguments.length; l++) {
          const p = arguments[l];
          if (p) {
            for (const h in p) $jscomp.owns(p, h) && (k[h] = p[h]);
          }
        }
        return k;
      };
...
$jscomp.checkStringArgs = function (k, n, l) {
  if (k == null) throw new TypeError(`The 'this' value for String.prototype.${l} must not be null or undefined`);
...
$jscomp.polyfill(
  ...
  (k) => {
    return (
      k ||
      function (n, l) {
        const p = $jscomp.checkStringArgs(this, n, 'startsWith');
        n += '';
        const h = p.length;
        const A = n.length;
...
$jscomp.typedArrayCopyWithin = function (k) {
  return k || Array.prototype.copyWithin;
};
...
const DracoDecoderModule = (function () {
  let k = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : void 0;
  ...
  return function (n) {
    ...
    function p(e, b, c) {
      let d = b + c;
      for (c = b; e[c] && !(c >= d); ) ++c;
      if (c - b > 16 && e.buffer && va) return va.decode(e.subarray(b, c));
      for (d = ''; b < c; ) {
        let g = e[b++];
        if (g & 128) {
          const u = e[b++] & 63;
          if ((g & 224) == 192) {
            ...
            const X = e[b++] & 63;
            g = (g & 240) == 224 ? ((g & 15) << 12) | (u << 6) | X : ((g & 7) << 18) | (u << 12) | (X << 6) | (e[b++] & 63);
            g < 65536 ? (d += String.fromCharCode(g)) : ((g -= 65536), (d += String.fromCharCode(55296 | (g >> 10), 56320 | (g & 1023))));
          }
        } else {
    ...
    function ba() {
      function e() {
        if (!la && ((la = !0), (a.calledRun = !0), !wa)) {
          ...
          if (a.postRun) {
            for (typeof a.postRun == 'function' && (a.postRun = [a.postRun]); a.postRun.length; ) Ba.unshift(a.postRun.shift());
          }
          z(Ba);
        }
      }
      if (!(aa > 0)) {
        if (a.preRun) {
          for (typeof a.preRun == 'function' && (a.preRun = [a.preRun]); a.preRun.length; ) Ca.unshift(a.preRun.shift());
        }
        z(Ca);
        aa > 0 ||
          (a.setStatus
      ...
      if (typeof e === 'string') {
        ...
        if (d > 0) {
          ...
          for (let g = 0; g < e.length; ++g) {
            let u = e.charCodeAt(g);
            if (u >= 55296 && u <= 57343) {
              const X = e.charCodeAt(++g);
    ...
    a.isVersionSupported = function (e) {
      ...
      e = e.split('.');
      return e.length < 2 || e.length > 3 ? !1 : e[0] == 1 && e[1] >= 0 && e[1] <= 5 ? !0 : e[0] != 0 || e[1] > 10 ? !1 : !0;
    };
    let Xa = Object.assign({}, a);
    var xa = typeof window == 'object';
    var ha = typeof importScripts == 'function';
    const Ya = typeof process == 'object' && typeof process.versions == 'object' && typeof process.versions.node == 'string';
    var U = '';
    if (Ya) {
      const Za = require('node:fs');
      const qa = require('node:path');
      ...
      (ha ? (U = self.location.href) : typeof document != 'undefined' && document.currentScript && (U = document.currentScript.src),
        k && (U = k),
        (U = U.indexOf('blob:') !== 0 ? U.substr(0, U.replace(/[?#].*/, '').lastIndexOf('/') + 1) : ''),
        ($a = function (e) {
    ...
    const ud = a.print || console.log.bind(console);
    ...
    let ja;
    var wa = !1;
    var va = typeof TextDecoder != 'undefined' ? new TextDecoder('utf8') : void 0;
    let Y;
    let ea;
    let ca;
    let V;
    ...
    const xd = {
      ...
      c(e, b, c, d) {
        for (var g = 0, u = 0; u < c; u++) {
          ...
          const ab = V[(b + 4) >> 2];
          b += 8;
          for (let sa = 0; sa < ab; sa++) {
            const ta = ea[X + sa];
            const ua = wd[e];
            ta === 0 || ta === 10 ? ((e === 1 ? ud : da)(p(ua, 0)), (ua.length = 0)) : ua.push(ta);
          }
          g += ab;
        }
        V[d >> 2] = g;
    ...
    (function () {
      function e(g, u) {
        ...
        aa == 0 && (ra !== null && (clearInterval(ra), (ra = null)), ia && ((g = ia), (ia = null), g()));
      }
      function b(g) {
        e(g.instance);
      }
      ...
      (function () {
        return fa || typeof WebAssembly.instantiateStreaming != 'function' || P.startsWith('data:application/octet-stream;base64,') || P.startsWith('file://') || Ya || typeof fetch != 'function'
          ? c(b)
          : fetch(P, { credentials: 'same-origin' }).then((g) => {
              return WebAssembly.instantiateStreaming(g, d).then(b, (u) => {
    ...
    var r = {
      ...
      prepare() {
        if (r.needed) {
          for (let b = 0; b < r.temps.length; b++) a._free(r.temps[b]);
          r.temps.length = 0;
          a._free(r.buffer);
          r.buffer = 0;
          r.size += r.needed;
      ...
      alloc(b, c) {
        ...
        b = (b + 7) & -8;
        r.pos + b >= r.size ? (b > 0 || f(void 0), (r.needed += b), (c = a._malloc(b)), r.temps.push(c)) : ((c = r.buffer + r.pos), (r.pos += b));
        return c;
      },
      copy(b, c, d) {
        d >>>= 0;
        ...
        for (let g = 0; g < b.length; g++) c[d + g] = b[g];
      },
    };
